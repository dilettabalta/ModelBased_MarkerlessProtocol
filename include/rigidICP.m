...
% Reallignedsource=Reallignedsourcetemp*transformtarget.T+repmat(transformtarget.c(1,1:end),length(Reallignedsourcetemp(:,1)),1);
Reallignedsource=Reallignedsourcetemp;
[d,Reallignedsource,transform] = procrustes(Reallignedsource,source);
% scaling = [scaling transform.b];
% set(0, 'DefaultFigureVisible', 'on')
% figure;plot(scaling,'xr');
