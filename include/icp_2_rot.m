function [TR,TT,data,model,res] = icp_2_rot(model,data,maxIter,minIter,critFun,thres)
...
% cdm_d = mean(data,2);
% trasl = cdm_d-cdm_m';
% data = data - repmat(trasl,[1,size(data,2)]);
...
for iter=1:maxIter
    ...
    switch critFun
        ...
        case 0
            ...
            med=mean(data,2);
            if mTranspose
                mem=mean(model(vi,:),1); %punto medimente più vicino
